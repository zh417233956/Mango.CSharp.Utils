using Mango.Log4Net.ElasticSearch.Models;
using System;
...
namespace Mango.Log4Net.ElasticSearch.Logging
{
    ...
    public abstract class LogBase : ILog
    {
        ...
        /// </summary>
        /// <param name="message">日志消息</param>
        public virtual void Debug(LogEvent message)
        {
            if (IsDebugEnabled)
            {
        ...
        /// </summary>
        /// <param name="message">日志消息</param>
        public virtual void Info(LogEvent message)
        {
            if (IsInfoEnabled)
            {
        ...
        /// </summary>
        /// <param name="message">日志消息</param>
        public virtual void Warn(LogEvent message)
        {
            if (IsWarnEnabled)
            {
        ...
        /// </summary>
        /// <param name="message">日志消息</param>
        public virtual void Error(LogEvent message)
        {
            if (IsErrorEnabled)
            {
        ...
        public virtual void Error(LogEvent message, Exception exception)
        {
            if (IsErrorEnabled)
            {
        ...
        /// </summary>
        /// <param name="message">日志消息</param>
        public virtual void Fatal(LogEvent message)
        {
            if (IsFatalEnabled)
            {
        ...
        /// <param name="message">日志消息</param>
        /// <param name="exception">异常</param>
        public virtual void Fatal(LogEvent message, Exception exception)
        {
            if (IsFatalEnabled)
            {
