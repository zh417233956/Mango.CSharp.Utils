...
namespace Mango.Log4Net.ElasticSearch.Logging
{
    ...
    public interface ILogger
    {
        ...
        /// </summary>
        /// <param name="message">日志消息</param>
        void Warn(LogEvent message);

        /// <summary>
        /// 写入<see cref="LogLevel.Error"/>日志消息
        /// </summary>
        /// <param name="message">日志消息</param>
        void Error(LogEvent message);
        ...
        void Error(LogEvent message, Exception exception);

        /// <summary>
        /// 写入<see cref="LogLevel.Fatal"/>日志消息
        /// </summary>
        /// <param name="message">日志消息</param>
        void Fatal(LogEvent message);
        ...
        /// <param name="message">日志消息</param>
        /// <param name="exception">异常</param>
        void Fatal(LogEvent message, Exception exception);
