...
namespace Mango.Log4Net.ElasticSearch.Logging
{
    ...
    internal sealed class InternalLogger : ILogger
    {
        ...
        public void Debug(LogEvent message)
        {
        ...
        /// </summary>
        /// <param name="message">日志消息</param>
        public void Info(LogEvent message)
        {
        ...
        /// </summary>
        /// <param name="message">日志消息</param>
        public void Warn(LogEvent message)
        {
        ...
        /// </summary>
        /// <param name="message">日志消息</param>
        public void Error(LogEvent message)
        {
        ...
        public void Error(LogEvent message, Exception exception)
        {
            if (!IsEnabledFor(LogLevel.Error))
            {
                return;
        ...
        /// </summary>
        /// <param name="message">日志消息</param>
        public void Fatal(LogEvent message)
        {
        ...
        /// <param name="message">日志消息</param>
        /// <param name="exception">异常</param>
        public void Fatal(LogEvent message, Exception exception)
        {
            if (!IsEnabledFor(LogLevel.Fatal))
            {
                return;
